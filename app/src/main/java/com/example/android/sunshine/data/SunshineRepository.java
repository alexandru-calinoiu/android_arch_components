...
public class SunshineRepository {
    ...
    private SunshineRepository(WeatherDao weatherDao,
        ...
        MutableLiveData<WeatherEntry[]> currentWeatherForecasts = mWeatherNetworkDataSource.getCurrentWeatherForecasts();
        currentWeatherForecasts.observeForever(newForecastsFromNetwork -> {
    ...
    private boolean isFetchNeeded() {
        Date today = SunshineDateUtils.getNormalizedUtcDateForToday();
        return mWeatherDao.countAllFutureWeather(today) < 13;
    }
